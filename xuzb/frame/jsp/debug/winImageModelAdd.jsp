...
<ef:body>
	<ef:form name="formImageModel" title="图片模板信息" rowcount="5">
		...
		<ef:fileBox name="mbnr" label="模板内容" colspan="4" required="true"
			fileDesc="图片文件" sizeLimit="10240" fileType="*.jpg;*.png;*.jpeg" />
...
<script type="text/javascript">
	...
	function btnSaveClick() {
		...
		var url = new URL("debug.do", "saveImageModelAdd");
	...
	function btnClearClick() {
		getObject("formImageModel").clear();
		getObject("formImageModel").focus();
	}
</script>