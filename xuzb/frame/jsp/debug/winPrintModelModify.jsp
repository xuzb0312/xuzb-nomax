...
<ef:body>
	<ef:form title="打印格式模板信息" name="formPrint" dataSource="printinfo">
		...
		<ef:radiobuttonList label="格式状态" name="gszt" colspan="2"
...
<script type="text/javascript">
	...
	function btnSaveClick() {
		...
		var url = new URL("debug.do", "savePrintModelModify");
