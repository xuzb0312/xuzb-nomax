 ...
 * 
 * jQuery EasyUI menu Extensions 1.0 beta jQuery EasyUI menu 组件扩展
 * jeasyui.extensions.menu.js 二次开发 流云 最近更新：2014-05-13
 * 
...
(function ($, undefined) {
        ...
        function createMenu(menu) {
            ...
            if (menu.hasClass('menu-content')) {
                ...
                menu.children('div').each(function () {
					...
					// ['name', 'iconCls', 'href', { separator: 'boolean' }]), {
                    // disabled: (item.attr('disabled') ? true : undefined)
                    // });
                    // 注释掉上三行代码，并添加了下三行代码，以实现获取 menu-item 的属性
					// hideOnClick，该参数表示是否在点击菜单项后菜单自动隐藏
    ...
    /**
	 * mod.yjc.2015年7月2日 这个的代码导致在ie下菜单展示存在问题，将其备份，修正为以下的那个方法
	 * 
	 * @param target
	 * @param menu
	 * @return
	 */
    function setMenuWidth_bak(target, menu) {
    ...
    /**
	 * mod.yjc.2015年7月2日 增加此方法，取代上面的问题方法。
	 * 
	 * @param target
	 * @param menu
	 * @return
