﻿/**
 * ---------------注意----------------
 * 该文件进行了本地化的定制，禁止随意使用新版本的文件覆盖本文件内容。
 * easyui的许多特性，都均进行了本地化的特殊定制，禁止文件夹级别的全局覆盖。
 * -----------------------------------
 * jQuery EasyUI 1.3.5
 * 
 ...
 * @since mod.yjc.2015年6月25日 增加按钮图标的上下支持，最新版本特性
 * @since mod.yjc.2015年7月1日 对于panel标签的宽度支持占满空间，而高度进行自适应。
 */
(function($){
...
if(_71.iconCls){
t.find(".l-btn-left").append($("<span class=\"l-btn-icon\">&nbsp;</span>").addClass(_71.iconCls));//mod.yjc.2015.06.19增加按钮图标的上下支持，最新版本特性
t.find(".l-btn-left").addClass("l-btn-icon-"+_71.iconAlign);//mod.yjc.2015.06.19增加对于按钮上下的支持
}
}else{
...
if(opts.fitwidthonly){opts.height="auto";}//mod.yjc.2015.07.01高度自适应，宽度充满界面，需要fit=true
...
var t=$(_228);
//mod.yjc.2015.07.01修改增加fitwidthonly属性-只在宽度上充满
return $.extend({},$.parser.parseOptions(_228,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href",{cache:"boolean",fit:"boolean",fitwidthonly:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"}]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined)});
};
//mod.yjc.2015.07.01修改增加fitwidthonly属性-只在宽度上充满,默认否
$.fn.panel.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,fitwidthonly:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,tools:null,href:null,loadingMessage:"Loading...",extractor:function(data){
var _229=/<body[^>]*>((.|[\n\r])*)<\/body>/im;
...
_454.onCreateComplete.call(this); //mod.yjc.2015.07.03增加创建完成后触发的事件
};
...
},onCreateComplete:function(){//mod.yjc.2015年7月3日 增加事件，form创建完成后触发
},onLoadError:function(){
}};
})(jQuery);
(function($){
