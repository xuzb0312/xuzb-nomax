...
public class CheckBoxListTag extends Tag{
	...
	public int doEndTag() throws JspException {
		try {
			...
			// 复选框构造
			strBF.append("<table obj_type=\"checkboxlist\" width=\"100%\" id=\"")
				.append(this.name)
				.append("\" name=\"")
				.append(this.name)
				.append("\" ");
			...
			for (int i = 0, n = dsCode.size(); i < n; i++) {
				...
				optsBF.append("<input type=\"checkbox\" id=\"chk_opts_")
					.append(this.name)
					.append("_")
					.append(code)
					.append("\" ")
				...
				optsBF.append(" class=\"magic-checkbox\"/>");
				optsBF.append("<label for=\"chk_opts_")
					.append(this.name)
					.append("_")
					.append(code)
					.append("\">")
