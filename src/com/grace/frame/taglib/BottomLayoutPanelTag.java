 ...
 * @author yjc
 */
public class BottomLayoutPanelTag extends Tag{
	...
	public int doStartTag() throws JspException {
		try {
			...
			this.setEasyUICompAttr("region", "south", true);// 底部
	...
	private void checkData() throws AppException {
		...
		if (StringUtil.chkStrNull(this.height)) {
			throw new AppException("必须为本容器定义高度");
		}
	}
