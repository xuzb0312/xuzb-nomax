...
import com.grace.frame.util.echarts.code.SelectedMode;
import com.grace.frame.util.echarts.data.RangeData;
...
public class DataRange extends Basic<DataRange> implements Component{
	private static final long serialVersionUID = 4246442072733988482L;
	/**
	 ...
	 * {Function}，模板变量为'{value}'和'{value2}'，代表数值起始值和结束值，函数参数两个，含义同模板变量
	 */
