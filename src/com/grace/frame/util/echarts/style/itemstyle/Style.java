package com.grace.frame.util.echarts.style.itemstyle;

import com.grace.frame.util.echarts.Label;
import com.grace.frame.util.echarts.LabelLine;
import com.grace.frame.util.echarts.code.Position;
import com.grace.frame.util.echarts.style.*;
...
public abstract class Style<T> implements Serializable{
	 ...
	 * 饼图标签视觉引导线，默认显示
	 * 
	 * @see com.grace.frame.util.echarts.LabelLine
	 */
	 ...
	 * 区域样式
	 * 
	 * @see com.grace.frame.util.echarts.style.AreaStyle
	 */
	private AreaStyle areaStyle;
	/**
	 * 和弦图 - 弦样式
	 * 
	 * @see com.grace.frame.util.echarts.style.ChordStyle
	 */
	private ChordStyle chordStyle;
	/**
	 * 力导向图 - 弦样式
	 * 
	 * @see com.grace.frame.util.echarts.style.NodeStyle
	 */
	private NodeStyle nodeStyle;
	/**
	 * 力导向图 - 弦样式
	 * 
	 * @see com.grace.frame.util.echarts.style.LinkStyle
	 */
