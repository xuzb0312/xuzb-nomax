...
import com.grace.frame.util.echarts.Chart;
import com.grace.frame.util.echarts.Tooltip;
import com.grace.frame.util.echarts.code.*;
...
public abstract class Series<T> extends AbstractData<T> implements Chart{
	private static final long serialVersionUID = -8686500234181175311L;
	/**
	 ...
	 * 
	 * @see com.grace.frame.util.echarts.code.SeriesType
	 */
	 ...
	 * 
	 * @see com.grace.frame.util.echarts.Tooltip
	 */
	private Tooltip tooltip;
	/**
	 * 图形样式
	 * 
	 * @see com.grace.frame.util.echarts.style.ItemStyle
	 */
	private ItemStyle itemStyle;
	/**
	 * 标注
	 * 
	 * @see com.grace.frame.util.echarts.series.MarkPoint
	 */
	private MarkPoint markPoint;
	/**
	 * 标线
	 * 
	 * @see com.grace.frame.util.echarts.series.MarkLine
	 */
	...
	private Integer z;
	/**
	 * 图形上的文本标签，课用于说明图形的一些数据信息，比如值，名称等，label选项在 ECharts 2.x
