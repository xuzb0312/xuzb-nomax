...
import com.grace.frame.util.echarts.code.ColorMappingBy;
import com.grace.frame.util.echarts.code.NodeClick;
import com.grace.frame.util.echarts.code.Roam;
import com.grace.frame.util.echarts.code.SeriesType;
import com.grace.frame.util.echarts.series.other.Level;
import com.grace.frame.util.echarts.style.Breadcrumb;
...
public class Treemap extends Series<Treemap>{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2151473372594142626L;
	/**
	 * 中心坐标，支持绝对值（px）和百分比
	 */
