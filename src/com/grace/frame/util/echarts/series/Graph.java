...
import com.grace.frame.util.echarts.code.Layout;
...
import com.grace.frame.util.echarts.series.force.Category;
import com.grace.frame.util.echarts.series.force.Link;
import com.grace.frame.util.echarts.series.force.Node;
import com.grace.frame.util.echarts.series.other.Force;
...
public class Graph extends Series<Graph>{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5421304882573219184L;
	/**
	 * 图的布局
	 */
	...
	/**
	 * 在 500+ 顶点的图上建议设置 large 为 true, 会使用 Barnes-Hut simulation, 同时开启 useWorker
	 * 并且把 steps 值调大
	 */
	...
	/**
	 * 每一帧布局计算的迭代次数，因为每一帧绘制的时间经常会比布局时间长很多，所以在使用 web worker 的时候可以把 steps
	 * 调大来平衡两者的时间从而达到效率最优化
	 */
