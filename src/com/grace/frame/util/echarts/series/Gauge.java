...
import com.grace.frame.util.echarts.Label;
import com.grace.frame.util.echarts.Title;
import com.grace.frame.util.echarts.axis.AxisLine;
import com.grace.frame.util.echarts.axis.AxisTick;
import com.grace.frame.util.echarts.axis.SplitLine;
import com.grace.frame.util.echarts.code.SeriesType;
import com.grace.frame.util.echarts.series.gauge.Detail;
import com.grace.frame.util.echarts.series.gauge.Pointer;
...
public class Gauge extends Series<Gauge> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2810645377117090806L;
	/**
     ...
     * 坐标轴线，默认显示
     *
     * @see com.grace.frame.util.echarts.series.Line
     */
     ...
     * 指针样式
     *
     * @see com.grace.frame.util.echarts.series.gauge.Pointer
     */
    private Pointer pointer;
    /**
     * 仪表盘标题
     *
     * @see com.grace.frame.util.echarts.Title
     */
    private Title title;
    /**
     * 仪表盘详情
     *
     * @see com.grace.frame.util.echarts.series.gauge.Detail
     */
