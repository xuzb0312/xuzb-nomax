...
import com.grace.frame.util.echarts.code.Sort;
...
public class Funnel extends Series<Funnel> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3800650877038937985L;
	/**
     ...
     *
     * @see com.grace.frame.util.echarts.code.Sort
     */
    private Sort sort;
    /**
     * 数据图形间距
