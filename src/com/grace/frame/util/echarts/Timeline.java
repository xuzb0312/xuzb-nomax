...
import com.grace.frame.util.echarts.code.ControlPosition;
import com.grace.frame.util.echarts.code.TimeLineType;
import com.grace.frame.util.echarts.style.CheckpointStyle;
import com.grace.frame.util.echarts.style.ControlStyle;
...
public class Timeline extends AbstractData<Timeline> implements Component{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7035857541357349255L;
	/**
	 * 轴的类型
	 */
	 ...
	 * 
	 * @see com.grace.frame.util.echarts.code.TimeLineType
	 */
	...
	private Object x;
	/**
	 * 默认值null,时间轴左上角纵坐标，数值单位px，支持百分比（字符串）， 默认无，随y2定位，如'50%'(显示区域纵向中心)
	 */
	private Object y;
	/**
	...
	private Object y2;
	/**
	 * 默认值 auto 时间轴宽度，默认为总宽度 - x - x2，数值单位px，指定width后将忽略x2。见下图。
	 ...
	 * 
	 * @see com.grace.frame.util.echarts.code.ControlPosition
	 */
	...
	/**
	 * @see com.grace.frame.util.echarts.Label
	 */
	private Label label;
	/**
	 * 时间轴当前点
	 * 
	 * @see com.grace.frame.util.echarts.style.CheckpointStyle
	 */
	 ...
	 * 
	 * @see com.grace.frame.util.echarts.code.Symbol
	 * @see com.grace.frame.util.echarts.series.Series#symbol
	 */
