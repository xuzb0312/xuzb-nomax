...
import com.grace.frame.util.echarts.code.NameLocation;
import com.grace.frame.util.echarts.style.AreaSelectStyle;
import com.grace.frame.util.echarts.style.NameTextStyle;
...
public class ParallelAxis extends Axis<ParallelAxis> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 175702256952380929L;
	/**
     * 坐标轴的维度号
     */
    private Integer dim;
