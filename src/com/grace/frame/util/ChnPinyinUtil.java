...
class ChnPinyinUtil{
	 ...
	 */
	private static final String GB2312PyTable = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
			...
			+ "cccccccccccccccccccccccccccccccc"
			+ "cccccccccccccccccccccccccccccccc"
			+ "cccccddddddddddddddddddddddddddd"
			...
			+ "gggggggggggggggggggggggggggggggg"
			+ "gggggggggggggggggggggggggggggggg"
			+ "ggggggggggghhhhhhhhhhhhhhhhhhhhh"
			...
			+ "jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj"
			+ "jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj"
			+ "jjjjjjjkkkkkkkkkkkkkkkkkkkkkkkkk"
			+ "kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk"
			+ "kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk"
			+ "kkkkkkkkkkklllllllllllllllllllll"
			...
			+ "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm"
			+ "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm"
			+ "mmmmmmmmmmmmmmmmmmmmmmmmmmnnnnnn"
			+ "nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn"
			+ "nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn"
			+ "nnnnnnnnnnnooooooooppppppppppppp"
			+ "pppppppppppppppppppppppppppppppp"
			+ "pppppppppppppppppppppppppppppppp"
			+ "pppppppppppppppppppppppppppppppp"
			+ "pppppppppppppqqqqqqqqqqqqqqqqqqq"
			+ "qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq"
			+ "qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq"
			+ "qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq"
			+ "qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq"
			+ "qqqqqqqqqqrrrrrrrrrrrrrrrrrrrrrr"
			...
			+ "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww"
			+ "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww"
			+ "wwwwwwwwwwwwwwwwwwwwwwwxxxxxxxxx"
			...
			+ "yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy"
			+ "yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy"
			+ "yyyyyyyyzzzzzzzzzzzzzzzzzzzzzzzz"
			+ "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
			+ "zzzzzzzznzzzzzzzzzzzzzzzzzzzzzzz"
			+ "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
			+ "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
			+ "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
			+ "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
			...
			+ "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
			+ "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
			+ "zzzzzzzzzzz{{{{{cjwgnspgcgne{y{b"
			+ "tyyzdxykygt{jnnjqmbsgzscyjsyy{pg"
			+ "kbzgy{ywykgkljswkpjqhy{w{dzlsgmr"
			+ "ypywwcckznkyygttnjjeykkzytcjnmcy"
			+ "lqlypyqfqrpzslwbtgkjfyxjwzltbncx"
			+ "jjjjzxdttsqzycdxxhgck{phffss{ybg"
			+ "mxlpbyll{hlxs{zm{jhsojnghdzqyklg"
			+ "jhxgqzhxqgkezzwyscscjxyeyxadzpmd"
			+ "ssmzjzqjyzc{j{wqjbdzbxgznzcpwhkx"
			+ "hqkmwfbpbydtjzzkqhylygxfptyjyyzp"
			+ "szlfchmqshgmxxsxj{{dcsbbqbefsjyh"
			+ "xwgzkpylqbgldlcctnmayddkssngycsg"
			+ "xlyzaybnptsdkdylhgymylcxpy{jndqj"
			+ "wxqxfyyfjlejpzrxccqwqqsbzkymgplb"
			+ "mjrqcflnymyqmsqyrbcjthztqfrxqhxm"
			+ "jjcjlxxgjmshzkbswyemyltxfsydsgly"
			+ "cjqxsjnqbsctyhbftdcyzdjwyghqfrxw"
			+ "ckqkxebptlpxjzsrmebwhjlbjslyysmd"
			+ "xlclqkxlhxjrzjmfqhxhwywsbhtrxxgl"
			+ "hqhfnm{ykldyxzpwlgg{mtcfpajjzylj"
			+ "tyanjgbjplqgdzyqyaxbkysecjsznsly"
			+ "zhzxlzcghpxzhznytdsbcjkdlzayfmyd"
			+ "lebbgqyzkxgldndnyskjshdlyxbcghxy"
			+ "pkdqmmzngmmclgwzszxzjfznmlzzthcs"
			+ "ydbdllscddnlkjykjsycjlkohqasdknh"
			+ "csganhdaashtcplcpqybsdmpjlpzjoql"
			+ "cdhjjysprchn{nnlhlyyqyhwzptczgww"
			+ "mzffjqqqqyxaclbhkdjxdgmmydjxzlls"
			+ "ygxgkjrywzwyclzmssjzldbydcpcxyhl"
			+ "xchyzjq{{qagmnyxpfrkssbjlyxysygl"
			+ "nscmhswwmnzjjlxxhchsy{{ctxrycyxb"
			+ "yhcsmxjsznpwgpxxtaybgajcxly{dccw"
			+ "zocwkccsbnhcpdyznfcyytyckxkybsqk"
			+ "kytqqxfcwchcykelzqbsqyjqcclmthsy"
			+ "whmktlkjlycxwhyqqhtqh{pq{qscfymm"
			+ "dmgbwhwlgsllysdlmlxpthmjhwljzyhz"
			+ "jxhtxjlhxrswlwzjcbxmhzqxsdzpmgfc"
			+ "sglsxymqshxpjxwmyqksmyplrthbxftp"
			+ "mhyxlchlhlzylxgsssstclsltclrpbhz"
			+ "hxyyfhb{gdmycnqqwlqhjj{ywjzyejjd"
			+ "hpblqxtqkwhlchqxagtlxljxmsl{htzk"
			+ "zjecxjcjnmfby{sfywybjzgnysdzsqyr"
			+ "sljpclpwxsdwejbjcbcnaytwgmpabcly"
			+ "qpclzxsbnmsggfnzjjbzsfzyndxhplqk"
			+ "zczwalsbccjx{yzhwkypsgxfzfcdkhjg"
			+ "xdlqfsgdslqwzkxtmhsbgzmjzrglyjbp"
			+ "mlmsxlzjqshzyj{zydjwbmjklddpmjeg"
			+ "xyhylxhlqyqhkycwcjmyyxnatjhyccxz"
			+ "pcqlbzwwytwbqcmlpmyrjcccxfpznzzl"
			+ "jplxxyztzlgdldcklyrzzgqtgjhhgjlj"
			+ "axfgfjzslcfdqzlclgjdjcsnclljpjqd"
			+ "cclcjxmyzftsxgcgsbrzxjqqctzhgyqt"
			+ "jqqlzxjylylbcyamcstylpdjbyregkjz"
			+ "yzhlyszqlznwczcllwjqjjjkdgjzolbb"
			+ "zppglghtgzxyghzmycnqsycyhbhgxkam"
			+ "txyxnbskyzzgjzlqjdfcjxdygjqjjpmg"
			+ "wgjjjpkqsbgbmmcjssclpqpdxcdyyky{"
			+ "cjddyygywrhjrtgznyqldkljszzgzqzj"
			+ "gdykshpzmtlcpwnjafyzdjcnmwescygl"
			+ "btzcgmssllyxqsxsbsjsbbsgghfjlypm"
			+ "zjnlyywdqshzxtyywhmzyhywdbxbtlms"
			+ "yyyfsxjc{txxlhjhf{sxzqhfzmzcztqc"
			+ "xzxrttdjhnnyzqqmnqdmmg{ytxmjgdhc"
			+ "dyzbffallztdltfxmxqzdngwqdbdczjd"
			+ "xbzgsqqddjcmbkzffxmkdmdsyyszcmlj"
			+ "dsynsprskmkmpcklgdbqtfzswtfgglyp"
			+ "lljzhgj{gypzltcsmcnbtjbqfkthbyzg"
			+ "kpbbymtdssxtbnpdkleycjnyddykztdh"
			+ "qhsdzsctarlltkzlgecllkjlqjaqnbdk"
			+ "kghpjtzqksecshalqfmmgjnlyjbbtmly"
			+ "zxdcjpldlpcqdhzycbzsczbzmsljflkr"
			+ "zjsnfrgjhxpdhyjybzgdljcsezgxlblh"
			+ "yxtwmabchecmwyjyzlljjyhlg{djlsly"
			+ "gkdzpzxjyyzlwcxszfgwyydlyhcljscm"
			+ "bjhblyzlycblydpdqysxqzbytdkyyjy{"
			+ "cnrjmpdjgklcljbctbjddbblblczqrpp"
			+ "xjcglzcshltoljnmdddlngkaqhqhjhyk"
			+ "heznmshrp{qqjchgmfprxhjgdychghly"
			+ "rzqlcyqjnzsqtkqjymszswlcfqqqxyfg"
			+ "gyptqwlmcrnfkkfsyylqbmqammmyxctp"
			+ "shcptxxzzsmphpshmclmldqfyqxszyjd"
			+ "jjzzhqpdszglstjbckbxyqzjsgpsxqzq"
			+ "zrqtbdkyxzkhhgflbcsmdldgdzdblzyy"
			+ "cxnncsybzbfglzzxswmsccmqnjqsbdqs"
			+ "jtxxmbltxzclzshzcxrqjgjylxzfjphy"
			+ "{zqqydfqjjlzznzjcdgzygctxmzysctl"
			+ "kphtxhtlbjxjlxscdqxcbbtjfqzfsltj"
			+ "btkqbxxjjljchczdbzjdczjdcprnpqcj"
			+ "pfczlclzxzdmxmphjsgzgszzqlylwtjp"
			+ "fsyaxmcjbtzyycwmytcsjjlqcqlwzmal"
			+ "bxyfbpnlsfhtgjwejjxxglljstgshjql"
			+ "zfkcgnndszfdeqfhbsaqtgylbxmmygsz"
			+ "ldydqmjjrgbjtkgdhgkblqkbdmbylxwc"
			+ "xyttybkmrtjzxqjbhlmhmjjzmqasldcy" + "xyqdlqcafywyxqhz";

	private static final StringBuffer gbk2 = new StringBuffer("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabbbbbbbbbbbbbp"
	...
	private static final StringBuffer gbk3 = new StringBuffer("ksxsm sdqlybjjjgczbjfya jhphsyzgj   sn      xy  ng"
	...
	public static String getGB2312py(String hzString) throws AppException {
		...
		try {
			...
			throw new AppException("字符串用GB2312编码：" + e.getMessage());
		}
		String eRe = "";
		int Hz_1 = 0, Hz_2 = 0;
		int HzPos = 0;
	...
	public static String getGBKpy(String hzString) throws AppException {
		...
		try {
			...
			throw new AppException("字符串用GBK编码出错" + e.getMessage());
		}
		len = eB.length;
